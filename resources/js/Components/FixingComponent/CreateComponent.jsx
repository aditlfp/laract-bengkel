...
export default function CreateComponent({ datas }) {
    const baseUrl = datas.baseUrl || "";
    const [data1, setData1] = useState({ jenis_kerusakan1: [] });
    const [data2, setData2] = useState({ nama_panel1: [] });
    ...
    const handleCheckBox = (e) => {
        ...
        const selected = [...data1.jenis_kerusakan1];
    ...
    const handleCheckBoxPanel = (e) => {
        ...
        const selected = [...data2.nama_panel1];
                        ...
                        return (
                            ...
                            >
                                ...
                                <div className="flex w-full items-center gap-2">
                                    ...
                                    />
                                    <span className="text-xs font-medium text-slate-700">{option.panel}</span>
                                </div>
                            </label>
                        );
                    })}
